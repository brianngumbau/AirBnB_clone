...
class TestUser(unittest.TestCase):
    ...
    def test_user_isStr_email(self):
        """ test that email public attribute is a string """
        self.assertTrue(isinstance(getattr(self.user, 'email', None),
                        str))
    ...
    def test_user_isStr_first_name(self):
        """ test that first_name public attribute is a string """
        self.assertTrue(isinstance(getattr(self.user, 'first_name', None),
                        str))
    ...
    def test_user_isStr_password(self):
        """ test that password public attribute is a string """
        self.assertTrue(isinstance(getattr(self.user, 'password', None),
                        str))
    ...
    def test_user_isStr_last_name(self):
        """ test that last_name public attribute is a string """
        self.assertTrue(isinstance(getattr(self.user, 'last_name', None),
                        str))
